...
class CardPredictor:
    ...
    def predict(self, car_pic, resize_rate=1):
        ...
        if pic_width > MAX_WIDTH:
            ...
            img = cv2.resize(img, (MAX_WIDTH, int(pic_hight * pic_rate)),
        ...
        try:
            ...
            image, contours, hierarchy = cv2.findContours(img_edge2,
                                                          cv2.RETR_TREE,
                                                          cv2.CHAIN_APPROX_SIMPLE)
        ...
        for card_index, card_img in enumerate(card_imgs):
            ...
            card_imgs[card_index] = card_img[yl:yh,
                    ...
                    yh - yl) // 4 else card_img[yl - (yh - yl) // 4:yh,
                                       xl:xr]
